...
lo = User.create!(email:'brown.angelo@sbcglobal.net', password: '123456')
lo.tips.create(offense: 'Robbery', location: 'Reston', img_url:"")

# tips = Tip.create!([
#   {offense: "Robbery", location: "Columbia Heights", img_url: "http://media2.wxyz.com/photo/2015/01/29/7-11%20robbery,%2006-20-14_1422543137400_12862758_ver1.0_640_480.JPG", user: "lo"}
#  ])
